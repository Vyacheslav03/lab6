...
// не распахнуто на весь экран
    ...
    private JMenuItem pauseRedItem;
...
// Создать меню
        ...
        Action resumeAction = new AbstractAction("Возобновить движение") {
            public void actionPerformed(ActionEvent event) {
                ...
                pauseRedItem.setEnabled(true);
            }
        };
        resumeMenuItem = controlMenu.add(resumeAction);
        resumeMenuItem.setEnabled(false);
        // метод для остановки красные
        Action pauseGreen = new AbstractAction("Приостановить красные") {
            public void actionPerformed(ActionEvent event) {
                field.pauseRed();
                pauseMenuItem.setEnabled(true);
                resumeMenuItem.setEnabled(true);
                pauseRedItem.setEnabled(false);
            }
        };
        pauseRedItem = controlMenu.add(pauseGreen);
        pauseRedItem.setEnabled(true);
